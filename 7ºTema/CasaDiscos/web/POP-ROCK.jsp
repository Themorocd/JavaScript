<%-- 
    Document   : POP-ROCK
    Created on : 12 feb. 2024, 12:46:25
    Author     : Andres
--%>
    ...
    <body>
        <table border="5" align="center">
            ...
            <tbody>
                ...
                String sql ="Select * from disco where idcategoria ='4'";
                ArrayList<Discos> Listapop = BBDD.BD.consultadiscos(sql);
